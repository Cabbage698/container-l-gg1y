...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-l-gg1y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-l-gg1y.containers.anotherwebservice.com/
...
```
git clone git@github.com:Cabbage698/container-l-gg1y.git
cd container-l-gg1y
```
...
```
docker attach container-l-gg1y
```
